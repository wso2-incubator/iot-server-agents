...
public class AgentUI extends javax.swing.JFrame {
	...
	private void initComponents() {
		...
		spinnerInterval.setModel(new javax.swing.SpinnerNumberModel(
				AgentManager.getInstance().getPushInterval(), Integer.valueOf(1), null,
				Integer.valueOf(1)));
		...
		try {
			...
			Image scaledBulbOn = imgBulbOn.getScaledInstance(pnlBulbStatus.getWidth(),
			                                                 pnlBulbStatus.getHeight(),
			                                                 Image.SCALE_SMOOTH);
			...
			Image scaledBulbOff = imgBulbOff.getScaledInstance(pnlBulbStatus.getWidth(),
			                                                   pnlBulbStatus.getHeight(),
			                                                   Image.SCALE_SMOOTH);
	...
	private void spinnerTemperatureStateChanged(javax.swing.event.ChangeEvent evt) {
		if (!isTemperatureRandomized) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Invalid temperature value", "Error",
	...
	private void spinnerHumidityStateChanged(javax.swing.event.ChangeEvent evt) {
		if (!isHumidityRandomized) {
			try {
				...
				JOptionPane.showMessageDialog(this, "Invalid humidity value", "Error",
				                              JOptionPane.ERROR_MESSAGE);
	...
	private void spinnerIntervalStateChanged(javax.swing.event.ChangeEvent evt) {
		try {
			...
			JOptionPane.showMessageDialog(this, "Invalid time interval value", "Error",
			                              JOptionPane.ERROR_MESSAGE);
