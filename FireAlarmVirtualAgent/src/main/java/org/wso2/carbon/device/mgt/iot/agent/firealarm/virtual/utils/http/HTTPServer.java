...
public class HTTPServer {
	...
	public HTTPServer() {
		new HTTPServer(AgentConstants.DEFAULT_DEVICE_SERVER_PORT);
	}
	...
	public void startServer() throws AgentCoreOperationException {
		try {
			server.start();
			log.info(AgentConstants.LOG_APPENDER + "HTTP Server started at port: " + port);
		} catch (Exception ex) {
			String errorMsg = "Unable to start HTTP server at port: " + port;
